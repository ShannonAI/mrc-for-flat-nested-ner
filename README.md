...
Then run 
`python3 evaluate.py $OUTPUT_DIR/<best_ckpt_on_dev>.ckpt  $OUTPUT_DIR/lightning_logs/<version_0/hparams.yaml>` <br>
to evaluate on the test set with the best checkpoint chosen on dev. 
